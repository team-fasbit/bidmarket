<div class="container border">
  <div id="view_account_owner_container">
     <div class="row">
        <div class="col">
  ...
  <div id="edit_account_owner_container">
   <form id="edit_account_owners_form">    
     <div class="row">
        <div class="col">
            <div class="form-group">
                Phone 1: <?php echo $phone1; ?>
    ...
    <div class="row">
        <div class="col">
            <div class="form-group" style="text-align:center;">
              <input type="hidden" id="account_owner_id" value="<?php echo $signup_key; ?>">
...
<script type="text/javascript">
   ...
   jQuery(document).ready( function($) {
        jQuery("#view_account_owner_container").show();
        jQuery("#edit_account_owner_container").hide();
        jQuery("#edit_account_owner").on("click", function(){
          jQuery("#view_account_owner_container").hide();
          jQuery("#edit_account_owner_container").show();
        });
   jQuery("#edit_account_owners_form").validate({
          ignore: [],
          rules: {
                 twitter:"required",
                 facebook: "required",
          ...
          submitHandler: function(response){
            var id=jQuery("#account_owner_id").val();
            ...
            jQuery.post(ajaxurl, data, function(response) {
                ...
                jQuery("#edit_account_owner_container").hide();
                alert('Success');
                jQuery("#view_account_owner_container").html((response));
            });
          }
        });
  }); 
